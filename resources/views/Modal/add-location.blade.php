<!-- Main modal -->
<div id="create-location" tabindex="-1" aria-hidden="true"
		...
		<div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
			...
			<div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
				...
				<button type="button"
					...
					data-modal-toggle="create-location">
			...
			<div class="p-6 space-y-6">
				<form action="{{ route('seller.shipping-fee.store') }}" method="POST" enctype="multipart/form-data">
					@csrf
					<div class="mb-4">
						<label for="location_name" class="block text-sm font-medium text-gray-900 dark:text-white mb-2">Location
							Address or Name</label>
						...
						<div class="mb-4">
							<label for="price" class="block text-sm font-medium text-gray-900 dark:text-white mb-2">Shipping Price</label>
