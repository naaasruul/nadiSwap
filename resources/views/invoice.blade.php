<x-layouts.customer-layout>
	<section class="bg-gray-50 dark:bg-gray-900 py-12">
		...
		<div class="mb-4">
			<a href="{{ route('my-account') }}" class="hover:underline focus:ring-0 focus:outline-none inline-flex items-center bg-primary-700 hover:bg-primary-800 text-white font-medium rounded-lg text-sm py-2 dark:bg-primary-600 dark:hover:bg-primary-700">
				<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="mr-4" viewBox="0 0 16 16">
