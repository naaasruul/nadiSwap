                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-start mt-4 p-4 bg-red-50 rounded-lg">
                                <span class="text-xl mr-3">❌</span>
                                <div class="flex-1">
                                    <p class="text-xs text-red-500 font-medium mb-1">Order Cancelled</p>
                                    <p class="font-medium text-gray-900">{{ $order->cancellation->formatted_cancelled_at }}</p>
                                    <div class="mt-2 text-sm">
                                        <p class="text-gray-700"><span class="font-medium">Reason:</span> {{ $order->cancellation_reason }}</p>
                                        @if($order->cancellation->hasComments())
                                            <p class="text-gray-600 mt-1"><span class="font-medium">Comments:</span> {{ $order->cancellation->additional_comments }}</p>
                                        @endif
                                        <p class="text-gray-500 mt-1 text-xs">Cancelled by {{ $order->cancellation->cancelled_by_role }}</p>
                                    </div>
                                </div>
                            </div>
                            @endif
