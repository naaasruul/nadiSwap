        ...
        <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
            <div class="sm:col-span-2">
                <label for="house-type" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Address /
                    Place</label>
                <gmpx-api-loader key="{{ env('GOOGLE_API_KEY') }}" solution-channel="GMP_GE_placepicker_v2">
                </gmpx-api-loader>
            ...
            <div class="sm:col-span-2">
                <label for="location"
                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">People Rent</label>
                <input type="number" min='1' name="tenant_total" id="tenant_total" placeholder="How many tenant can rent?"
