            ...
            <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
              ...
              <div class="mb-4 items-end justify-between space-y-4 sm:flex sm:space-y-0 md:mb-8">
                <div>
                  ...
                  <form action="{{ route('buyer.dashboard') }}" method="GET" class="flex items-center mt-4">   
                      ...
                      <button type="submit" class="inline-flex w-auto cursor-pointer items-center rounded-lg border border-primary-700 bg-primary-700 p-2.5 text-center text-sm font-medium text-white hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
              ...
              <div class="mb-4 grid gap-4 sm:grid-cols-2 md:mb-8 lg:grid-cols-3 xl:grid-cols-4">
                ...
                <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                    <div class="h-56 w-full">
                      ...
                      <img class="mx-auto h-full dark:hidden" src="{{ asset( $product->image)  }}" alt="" />
                      <img class="mx-auto hidden h-full dark:block" src="{{ asset($product->image)  }}" alt="" />
                    </a>
                  </div>
                    ...
                    <div id="myTabContent">
                      <div class="grid grid-cols-2 gap-4 md:grid-cols-3" id="brand" role="tabpanel" aria-labelledby="brand-tab">
                        ...
                        <div class="space-y-2">
                          ...
                          <div class="flex items-center">
                            <input id="extreme" type="checkbox" value="" class="h-4 w-4 rounded border-gray-300 bg-gray```blade
-100 text-primary-600 focus:ring-2 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-primary-600" />
