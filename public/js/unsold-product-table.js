if (document.getElementById("unsold-product-table") && typeof simpleDatatables.DataTable !== 'undefined') {
    ...
    const table = new simpleDatatables.DataTable("#unsold-product-table", {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    productIds.forEach(id => {
                        const row = document.querySelector(`#unsold-product-table tr[data-id="${id}"]`);
                        if (row) {
                            row.remove();
                        }
                    });
